...
// => 피연자의 갯수에 따라 단항 연산자(1개), 이항 연산자(2개), 삼항 연산자(3개)로 구분
...
public class OperatorApp {
	public static void main(String[] args) {
		...
		// => ~ : Bit Not 연산자(1의 보수 연산자) - 피연산자(정수값)의 Bit단위로 표현된 값을
		//반대로 변환하여 제공하는 연산자
		...
		int b1=++a4;//전처리 : ++a4 명령을 실행하고 결과값은 b1 변수에 저장
		...
		//50(10) : 4Btye(32Bit) -  00000000000000000000000000110010
