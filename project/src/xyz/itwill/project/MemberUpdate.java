...
public class MemberUpdate extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MemberUpdate dialog = new MemberUpdate();
	...
	public MemberUpdate() {
		...
		{
			JLabel lblNewLabel_2 = new JLabel("셍년월일");
		...
		{
			JLabel lblNewLabel_6 = new JLabel("가입일");
		...
		{
			JLabel lblNewLabel_7 = new JLabel("이용 횟수");
