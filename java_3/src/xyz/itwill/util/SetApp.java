...
//콜렉션 클래스(Collection Class) : 자료구조를 사용하여 다수의 객체(값)를
//효율적으로 저장하여 관리(추가, 변경, 삭제, 검색)하기 위한 기능을 제공하는 객체 수집 클래스를
//포괄적으로 표현한 이름
//다수의 객체(값)을 저장하기 위한 요소(Element)의 모임
// =>콜렉션클래스는 Collection 인터페이스 또는 Map 인터페이스를 상속받아 작성된 클래스
...
public class SetApp {
	public static void main(String[] args) {
		...
		System.out.println("Set 객체에 저장된 요쇼의 객체 = "+set.size());
